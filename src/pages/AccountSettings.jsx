...
export default function AccountSettings({ setPage }) {
  const { user, profile, streak, settings, updateUser, updateSettings, setFocusMode } = useAuth();
          ...
          <section className="card as-section">
            ...
            <div className="as-form">
              ...
              <div className="form-group">
                ...
                <p className="as-field-hint">Email is tied to your local demo account and cannot be changed here.</p>
              </div>
